            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
              ...
              <div>
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-lg font-bold text-green-600 dark:text-green-400">Wellora</span>
                </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <li><a href="#" className="hover:text-green-600 dark:hover:text-green-400 transition">Careers</a></li>
                  <li><a href="#" className="hover:text-green-600 dark:hover:text-green-400 transition">Blog</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  <li><a href="#" className="hover:text-green-600 dark:hover:text-green-400 transition">FAQ</a></li>
                  <li><a href="#" className="hover:text-green-600 dark:hover:text-green-400 transition">Contact Us</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-4">
                  <a href="#" className="text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 transition">
